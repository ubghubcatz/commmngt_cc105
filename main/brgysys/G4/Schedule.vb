...
Public Class Schedule
    ...
    Private Sub LoadShiftsII()
        ...
        If Not ((cboFilter.Text = "All") Or (cboFilter.Text = "Barangay Tanod") Or (cboFilter.Text = "Barangay Health Worker")) Then
            query = "SELECT ShiftID, EmployeeName, EmployeeID, Role, ShiftDate, StartTime, EndTime FROM g4_ShiftSchedule where employeeid='" & cboFilter.Text & "'"
        Else
            Select Case cboFilter.Text
                Case "All"
                    query = "SELECT ShiftID, EmployeeName, EmployeeID, Role, ShiftDate, StartTime, EndTime FROM g4_ShiftSchedule"
                Case "Barangay Tanod"
                    query = "SELECT ShiftID, EmployeeName, EmployeeID, Role, ShiftDate, StartTime, EndTime FROM g4_ShiftSchedule where Role='Barangay Tanod'"
