...
User Id=ublipa_SQLLogin_1;Password=nktg6ikffl;TrustServerCertificate=True;"
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        Using conn As New SqlConnection(connectionString)
            ...
            Dim result = MessageBox.Show("Complete?", "Confirm", MessageBoxButtons.YesNo)
            If result = DialogResult.Yes Then
                ...
                cmd.Parameters.AddWithValue("@status", "Completed") ' Adding the "approved" string
    ...
    Private Sub DeleteRowFromDatabase(id As Integer)
        Using connection As New SqlConnection(connectionString)
            Dim query As String = "DELETE FROM g6_Approved WHERE ID = @ID" ' Replace "ID" with your actual primary key column name
