...
Public Class g3CommandCenter_Form
    ...
    Private Sub Form1_Resize(sender As Object, e As EventArgs) Handles Me.Resize
        ...
        CountCases()
    End Sub
    Public Sub OpenOrRestoreForm(formType As Type, mdiParentForm As Form)
        ' Search if the form is already open inside the MDI parent
        For Each childForm As Form In mdiParentForm.MdiChildren
        ...
        ' Form not found, so create a new one
