...
Partial Class PendingMENU
    ...
    Private Sub InitializeComponent()
        ...
        Label6.Location = New Point(64, 482)
        Label6.Name = "Label6"
        ...
        ' email
        ' 
        email.Font = New Font("Segoe UI", 7.8F, FontStyle.Bold)
        email.Location = New Point(12, 679)
        email.Name = "email"
        email.ReadOnly = True
        email.Size = New Size(239, 25)
        email.TabIndex = 94
        ' 
        ' Label10
        ' 
        ...
        Label10.Font = New Font("Segoe UI", 7.8F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        ...
        ' nameinf
        ' 
        nameinf.Font = New Font("Segoe UI", 7.8F, FontStyle.Bold)
        nameinf.Location = New Point(12, 527)
        nameinf.Name = "nameinf"
        nameinf.ReadOnly = True
        nameinf.Size = New Size(239, 25)
        nameinf.TabIndex = 92
        ' 
        ' Label9
        ' 
        ...
        Label7.Location = New Point(307, 482)
        Label7.Name = "Label7"
        ...
        Label1.Location = New Point(537, 482)
        Label1.Name = "Label1"
        ...
        endsche.TabIndex = 102
        ' 
        ' venue
        ' 
        venue.Font = New Font("Segoe UI", 7.8F, FontStyle.Bold)
        venue.Location = New Point(257, 679)
        venue.Name = "venue"
        venue.ReadOnly = True
        ...
        type.Location = New Point(257, 628)
        type.Name = "type"
        type.ReadOnly = True
        ...
        Label2.Location = New Point(14, 557)
        Label2.Name = "Label2"
        ...
        lname.Location = New Point(14, 578)
        lname.Name = "lname"
        lname.ReadOnly = True
    ...
    Friend WithEvents nameinf As TextBox
