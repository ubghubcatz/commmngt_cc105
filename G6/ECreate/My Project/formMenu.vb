...
User Id=ublipa_SQLLogin_1;Password=nktg6ikffl;TrustServerCertificate=True;"
    ...
    Private Sub LoadDataGridView()
        Using conn As New SqlConnection(connectionString)
            conn.Open()
            Dim query As String = "SELECT ID, Name, Contact, Email, EventName, Attendees, Type, Venue, DateBooked, StartTime, EndTime FROM g6_History"
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        Using con As New SqlConnection(connectionString)
            ...
            Try
                ' Update the history
                Dim updateHistoryQuery As String = "UPDATE g6_History SET Name = @name, Contact = @contact, Attendees = @attendee, Type = @eventType, Venue = @venue, DateBooked = @dateSche, StartTime = @startT, EndTime = @endT WHERE ID = @ID"
                Using updateHistoryCmd As New SqlCommand(updateHistoryQuery, con, transaction)
                    ...
                    updateHistoryCmd.Parameters.AddWithValue("@ID", selectedID) ' Add the ID parameter
